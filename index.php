    ...
    <div class="m-header">
      <a href="dashboard/index.html" class="b-brand text-primary">
        ...
        <!---<img src="assets/images/logo-dark.svg" class="img-fluid logo-lg" alt="logo">  --->
			...
			<img src="assets/images/hoe_logo.jpg" class="img-fluid" alt="logo" style="margin-bottom:2px !important; margin-top:10px !important; height:60px;">
          ...
          <div class="col-12">
            <div class="d-grid"
              ><a
                ...
                href="C:/xampp/htdocs/HoE_prototype/dashboard/index.html">Check Now</a
              ></div
            >
          </div>
        </div>
...
<!-- [ Header ] end -->
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <h6 class="mb-0"> <a href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_pc_layout_2">All Earnings </a></h6>
                  </div>
				  <div class="pct-c-btn">
    ...
    <div class="offcanvas border-0 pct-offcanvas offcanvas-end" tabindex="-1" id="offcanvas_pc_layout">
	 ...
	 <div class="offcanvas border-0 pct-offcanvas offcanvas-end" tabindex="-1" id="offcanvas_pc_layout_2">
      <div class="offcanvas-header">
        <h5 class="offcanvas-title">Settings!!!</h5>
        <button type="button" class="btn btn-icon btn-link-danger" data-bs-dismiss="offcanvas" aria-label="Close"><i
            class="ti ti-x"></i></button>
